...
tf.flags.DEFINE_string("data_dir1", "../data1/personalized-dialog-dataset/full",
                       "Directory containing personalized dialog tasks")
tf.flags.DEFINE_string("data_dir11", "../data11/personalized-dialog-dataset/full",
                       "Directory containing personalized dialog tasks")
tf.flags.DEFINE_string("model_dir1", "model/", "Directory containing memn2n model checkpoints")
tf.flags.DEFINE_string("model_dir11", "model/", "Directory containing memn2n model checkpoints")
...
# model_dir1 = "1task" + str(FLAGS.task_id) + "_" + FLAGS.model_dir1
# chatbot1 = chatBot(FLAGS.data_dir1, model_dir1, FLAGS.task_id, OOV=FLAGS.OOV,
...
# print("first is done")
model_dir11 = "11task" + str(FLAGS.task_id) + "_" + FLAGS.model_dir11
chatbot11 = chatBot(FLAGS.data_dir11, model_dir11, FLAGS.task_id, OOV=FLAGS.OOV,
                      batch_size=FLAGS.batch_size, memory_size=FLAGS.memory_size,
                      epochs=FLAGS.epochs, hops=FLAGS.hops, save_vocab=FLAGS.save_vocab,
                      load_vocab=FLAGS.load_vocab, learning_rate=FLAGS.learning_rate,
                      embedding_size=FLAGS.embedding_size)
...
def create_task():
    ...
    if way == "start":
        f = open(
            "../data1/personalized-dialog-dataset/full/personalized-dialog-task1-API-calls-tst.txt", "w")
        txt = ["1 " + to + "," + pro,
               "2 <SILENCE>" + "	greetings sir 8:00 3",
               "3 <SILENCE>" + "	greetings sir 8:00 3",
               "4 <SILENCE>" + "	greetings sir 8:00 3",
               "5 <SILENCE>" + "	greetings sir 8:00 3"]
        for i in range(len(txt)):
            f.write(txt[i])
            f.write("\n")
        f.close()
        #ans = chatbot1.test2("../data1/personalized-dialog-dataset/full/")
    #elif way == "sayAll":
        #data = chatbot11.test2("../data11/personalized-dialog-dataset/full/")
    # elif way == "wait":
...
if __name__ == '__main__':
    ...
    #chatbot1.close_session()
    #chatbot11.close_session()
